...
import com.otamurod.pdpuz.databinding.FragmentAllCoursesBinding
 ...
 * Use the [AllCoursesFragment.newInstance] factory method to
...
class AllCoursesFragment : Fragment() {
    ...
    lateinit var allCoursesBinding: FragmentAllCoursesBinding
    ...
    override fun onCreateView(
        ...
        allCoursesBinding = FragmentAllCoursesBinding.inflate(layoutInflater, container, false)
        ...
        courseAdapter = CourseAdapter(list, object : CourseAdapter.OnItemClickListener {
            override fun onItemClick(course: Course) {
                ...
                findNavController().navigate(R.id.courseGroupFragment, bundle)
            }
        })

        allCoursesBinding.rvCourse.adapter = courseAdapter

        return allCoursesBinding.root
    }
