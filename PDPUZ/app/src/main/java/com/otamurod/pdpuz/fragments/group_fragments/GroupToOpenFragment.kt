...
import com.otamurod.pdpuz.databinding.FragmentGroupToOpenBinding
 ...
 * Use the [GroupToOpenFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class GroupToOpenFragment : Fragment() {
    ...
    lateinit var groupToOpenBinding: FragmentGroupToOpenBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mainNavController = Navigation.findNavController(getActivity, R.id.container_group)
    }
    ...
    override fun onCreateView(
        ...
        groupToOpenBinding = FragmentGroupToOpenBinding.inflate(layoutInflater, container, false)
        ...
        return groupToOpenBinding.root
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment GroupToOpenFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(courseId: Int) =
            GroupToOpenFragment().apply {
